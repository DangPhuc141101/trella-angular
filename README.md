...
<p align='center'>
  ...
  <a href="https://github.com:DangPhuc141101/trella-angular/blob/main/README.es-CO.md">Español</a>
</p>
...
[Create a repo from this template on GitHub](https://github.com:DangPhuc141101/trella-angular/generate).
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com:DangPhuc141101/trella-angular)

## 📦 Deploy to Netlify

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com:DangPhuc141101/trella-angular)
...
```sh
docker buildx build -t trella-angular:latest .
```

Run the image of the project.

```sh
docker run --rm -p 8080:80 -d trella-angular:latest
```
